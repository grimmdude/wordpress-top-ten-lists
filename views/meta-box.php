...
<div data-ng-app="topTenListsAngularApp" data-ng-controller="main" class="ng-cloak">
	<div style="border:1px dashed #ddd;margin-bottom:10px;padding:10px;overflow:hidden;" class="top-ten-list-item" data-ng-repeat="item in listItems">
		...
		<p data-ng-show="item.image_url">
			<img data-ng-src="{{item.image_url}}" data-ng-click="addImage($index)" style="height:200px;max-width:100%;cursor:pointer;" />
		</p>
		...
		<div style="clear:both;margin-top:10px;">
			<div style="float:left;">
				...
				<a href="javascript:;" style="text-decoration:none;" title="Move item down a number." data-ng-show="$index + 1 < listItems.length" data-ng-click="moveItemDown($index)"><span class="dashicons dashicons-arrow-down-alt"></span></a>
			</div>
			<div style="float:right;text-align:right;">
				<a href="javascript:;" style="color:#a00;" data-ng-click="removeItem($index)">Remove Item</a>
			</div>
		</div>
	</div>
